### 📄 **For a detailed report on this project, please download and review the PDF report included in the document.**<br>

This readme file explains some key code, although detailed comments are already included in the code. This document mainly explains the code for displaying some data and basic interactive functions on the map.<br>
